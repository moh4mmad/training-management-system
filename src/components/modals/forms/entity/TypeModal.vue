    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_type_header">
          <!--begin::Modal title-->
          <h2 class="fw-bolder">Add Type</h2>
          <!--end::Modal title-->
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_add_type_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_add_type_header"
              data-kt-scroll-wrappers="#kt_modal_add_type_scroll"
            ...
            >
              <div class="fv-row mb-7">
                ...
                <el-form-item prop="id">
                  <el-input v-model="formData.id" type="number" />
                </el-form-item>
                <!--end::Input-->
              </div>
              <div class="fv-row mb-7">
              ...
              <div class="fv-row mb-7">
                <!--begin::Label-->
                <label class="fs-6 fw-bold mb-2">
                  <span class="required">Entity Type Level </span>
                ...
                <!--begin::Input-->
                <el-form-item prop="entity_type_level">
                  <el-input
                    v-model="formData.entity_type_level"
                    type="number"
                  />
                </el-form-item>
                <!--end::Input-->
      ...
      formRef.value.validate(async (valid) => {
        if (valid) {
          ...
          const url = update.value
            ? "entity/types/" + `${formData?.value?.id}`
            : "entity/types";

          await ApiService[action](url, formData.value)
            .then((response) => {
              loading.value = false;
              bus.emit("type-updated", true);
