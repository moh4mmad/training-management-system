  ...
  <div class="card">
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
          <span class="card-label fw-bolder fs-3 mb-1">Industry Sector</span>
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:cell-sector_code="{ row: industry }">
          {{ industry.sector_code }}
        </template>
        <template v-slot:cell-sector_name="{ row: industry }">
        ...
        <div class="modal-body py-10 px-lg-17">
          <div class="table-responsive mt-5">
            ...
            >
              ...
              <tbody>
                <tr>
                  <td class="fw-bold">{{ data.sector_code }}</td>
                  <td class="fw-bold">{{ data.sector_name }}</td>
                  <td class="fw-bold">
...
import IndustrySectorModal from "@/components/modals/forms/settings/IndustrySectorModal.vue";
    ...
    Delete(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete("configurations/industry_sectors/" + `${id}`)
            .then((response) => {
