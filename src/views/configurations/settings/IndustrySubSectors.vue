  ...
  <div class="card">
      ...
      <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
          ...
          <input
            ...
            placeholder="Search Industry Sub Sector"
          />
        </div>
        <!--end::Search-->
      </div>
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:cell-sub_sector_code="{ row: industry }">
          {{ industry.sub_sector_code }}
        </template>
        <template v-slot:cell-sub_sector_name="{ row: industry }">
          {{ industry.sub_sector_name }}
        </template>
    ...
    <div class="modal-dialog mw-650px">
      <div class="modal-content">
        <div class="modal-header" id="kt_modal_add_industry_header">
          <h2 class="fw-bolder">Industry Details</h2>
          <div
        ...
        <div class="modal-body py-10 px-lg-17">
          <div class="table-responsive mt-5">
            ...
            >
              ...
              <tbody>
                <tr>
                  <td class="fw-bold">{{ data.sub_sector_code }}</td>
                  <td class="fw-bold">{{ data.sub_sector_name }}</td>
                  <td class="fw-bold">
                    {{ data.sub_sector_description }}
                  </td>
                </tr>
              </tbody>
            </table>
...
export default defineComponent({
  ...
  methods: {
    async getData() {
      await ApiService.get("configurations/industry_sub_sectors")
        .then((response) => {
    ...
    Delete(id) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ApiService.delete("configurations/industry_sub_sectors/" + `${id}`)
            .then((response) => {
