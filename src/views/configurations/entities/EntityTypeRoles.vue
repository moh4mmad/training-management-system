<template>
    ...
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
          <span class="card-label fw-bolder fs-3 mb-1">Entity Type Roles</span>
          ...
          <input
            ...
            placeholder="Search Entity Type Roles"
          />
        </div>
        <!--end::Search-->
      </div>
  ...
  <ExportTypeRoleModal></ExportTypeRoleModal>
...
import ExportTypeRoleModal from "@/components/modals/forms/entity/ExportTypeRoleModal.vue";
