<template>
    ...
    <div class="row">
      <div class="col align-self-start">
        ...
        <div class="input-group-append">
          <button
            class="btn btn-icon btn-light-info btn-square advanced_button"
            type="button"
          >
          ...
          <input
            type="text"
            placeholder="বিষয়/সিদ্ধান্ত দিয়ে খুঁজুন"
            name="list_daak_subject"
            title="বিষয়/সিদ্ধান্ত দিয়ে খুঁজুন"
            id="list_daak_subject"
          ...
          <button
            ...
            title="খুঁজুন"
            class="
              btn btn-icon btn-light-success btn-square
              daak_list_subject_search
            "
            type="button"
          >
          ...
          <button
            ...
            data-placement="left"
            title="রিসেট"
            class="btn btn-icon btn-light-danger btn-square"
            id="reset_btn"
            type="reset"
          >
          ...
          <button
            ...
            class="
              d-none
              btn btn-info btn-sm btn-square btn-nothi-list
              cd-btn
              js-cd-panel-trigger
            "
            data-panel="main"
          >
            <i class="fas fa-book"></i> নথিসমূহ
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex">
      <div id="daak_group_action_panel">
        <div class="d-flex flex-wrap">
          <div class="btn-group">
            <span
              class="input-group-text bg-transparent border-0 inbox_checkbox"
              data-toggle="popover"
              data-title="সকল ডাক বাছাই করুন"
              data-original-title=""
              title=""
            >
              <label
                class="checkbox checkbox-outline"
                id="alabel_checkbox_daak_item_toolbox"
                for="checkbox_daak_item_toolbox"
              >
                <input
                  type="checkbox"
                  id="checkbox_daak_item_toolbox"
                  name="checkbox_daak_item_toolbox"
                />
                <span></span>
              </label>
            </span>
            <div class="dropdown bootstrap-select form-control">
              <button
                type="button"
                tabindex="-1"
                class="btn dropdown-toggle btn-light border-0"
                data-toggle="dropdown"
                role="combobox"
                aria-owns="bs-select-1"
                aria-haspopup="listbox"
                aria-expanded="false"
                data-id="daak_status_selectpicker"
                title="সকল"
              >
                  ...
                  >
                    ...
                    <li>
                      <a
                        ...
                        id="bs-select-1-3"
                        tabindex="0"
                        ><span class="text">মূল-প্রাপক</span></a
                      >
                    </li>
                    <li>
                      <a
                        ...
                        id="bs-select-1-4"
                        tabindex="0"
                        ><span class="text">অনুলিপি</span></a
                      >
                    </li>
                  </ul>
                </div>
            ...
            <div class="input select">
              <div class="dropdown bootstrap-select form-control">
                <button
                  ...
                  aria-haspopup="listbox"
                  aria-expanded="false"
                  data-id="daak_security_selectpicker"
                  title="গোপনীয়তা"
                >
                  <div class="filter-option">
                    <div class="filter-option-inner">
                    ...
                    >
                      <li>
                        <a
                          ...
                          id="bs-select-3-0"
                          tabindex="0"
                          ><span class="text">বাছাই করুন</span></a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          id="bs-select-3-1"
                          tabindex="0"
                          ><span class="text">অতি গোপনীয়</span></a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          id="bs-select-3-2"
                          tabindex="0"
                          ><span class="text">বিশেষ গোপনীয়</span></a
                        >
                      </li>
                      <li>
                        <a
            ...
            <div class="input select">
              <div class="dropdown bootstrap-select form-control">
                <button
                  ...
                  aria-haspopup="listbox"
                  aria-expanded="false"
                  data-id="daak_type_selectpicker"
                  title="ডাকের ধরণ"
                >
                  <div class="filter-option">
                    <div class="filter-option-inner">
                    ...
                    >
                      <li>
                        <a
                          ...
                          id="bs-select-4-0"
                          tabindex="0"
                          ><span class="text">দাপ্তরিক</span></a
                        >
                      </li>
                      <li>
                        <a
            ...
            <div class="input select">
              <div class="dropdown bootstrap-select form-control">
                <button
                  ...
                  aria-haspopup="listbox"
                  aria-expanded="false"
                  data-id="daak_priority_selectpicker"
                  title="অগ্রাধিকার"
                >
                  <div class="filter-option">
                    <div class="filter-option-inner">
                    ...
                    >
                      ...
                      <li>
                        <a
                          ...
                          id="bs-select-5-1"
                          tabindex="0"
                          ><span class="text">সর্বোচ্চ অগ্রাধিকার</span></a
                        >
                      </li>
                      <li>
                        <a
                          ...
                          id="bs-select-5-2"
                          tabindex="0"
                          ><span class="text">অবিলম্বে</span></a
                        >
                      </li>
                      <li>
                        <a
          ...
          <div class="">
            <button
              type="button"
              class="btn btn-icon btn-daak-sort"
              data-toggle="tooltip"
          ...
          <div class="d-none" id="daak-toolbar">
            <div class="d-flex btn-daak-group bg-transparent">
              <button
                class="btn btn-icon mx-1 daak-seal-forward"
                type="button"
                data-toggle="tooltip"
                title="ডাক প্রেরণ করুন"
              >
                <span class="fas fa-share text-info"></span>
              </button>
              <button
                class="btn btn-icon mx-1 btn-nothivukto-selected"
                type="button"
                data-toggle="tooltip"
                title="নথিতে উপস্থাপন"
              >
                <i class="fas fa-books text-warning"></i>
              </button>
              <button
                class="btn btn-icon mx-1 btn-nothijato-selected"
                type="button"
                data-toggle="tooltip"
                title="নথিজাত"
              >
              ...
              <button
                class="btn btn-icon mx-1 btn-archive-selected"
                type="button"
                data-toggle="tooltip"
                title="আর্কাইভ"
              >
              ...
              <button
                id="btn-daak-toolbar-draft-send"
                class="btn btn-icon mx-1"
                type="button"
                data-toggle="tooltip"
                title="বাছাইকৃত ডাক প্রেরণ"
              >
                <span class="fas fa-share text-success"></span>
              </button>
              <button
                id="btn-daak-toolbar-dak-drafting"
                class="btn btn-icon mx-1 daak-seal-forward"
                type="button"
                data-toggle="tooltip"
                title="ডাক  সর্টিং"
          ...
          <div class="dropdown">
            ...
            >
              <i
                data-toggle="popover"
                data-content="তথ্য গোপন / প্রদর্শন"
                data-placement="top"
                class="fas fa-eye"
                data-original-title=""
                title=""
          ...
          >
            <i
              ...
              data-toggle="popover"
              data-content="ডিজিটাল পোস্টবক্স"
              data-original-title=""
              title=""
            ></i>
          </button>
          <div id="personal_folder_selected_name" class="d-none"></div>
        </div>
      </div>
    </div>
    <div
      id="daak_pagination_panel"
      class="float-right d-flex align-items-center"
      style="vertical-align: middle"
    >
      <span class="mr-2"
        ><span id="daak_item_length_start">১</span> -
        <span id="daak_item_length_end">৫</span> সর্বমোট:
        <span id="daak_item_total_record">৫</span></span
      >
      <div class="btn-group">
        <button
          class="btn-list-prev btn btn-icon btn-secondary btn-square"
          disabled="disabled"
          type="button"
        >
          <i
        ...
        <button
          class="btn-list-next btn btn-icon btn-secondary btn-square"
          type="button"
          disabled="disabled"
        >
          <i
  ...
  <h2 class="mt-3 text-primary ml-3">লিস্ট স্টাইল ১</h2>
  <div>
    <ul class="list-group list-group-flush">
      <li
        id="daak_container_inbox_1_54_Daptorik"
      ...
      >
        <div class="d-flex justify-content-between align-items-start">
          <span
            ...
            data-toggle="popover"
            data-content="ডাক বাছাই করুন"
            data-original-title=""
            title=""
          >
            <label class="checkbox checkbox-outline">
              <input
                data-draft-decisions=""
                type="checkbox"
                name="daak_container_inbox_daak_list_item_checkbox"
                data-attention="0"
              ...
              >
                ...
                <div class="font-weight-normal d-md-flex flex-wrap">
                  <div class="font-size-1-1">
                    <span class="mr-2 perok-wrapper">প্রেরক:</span
                    ><span
                      class="perok-wrapper sender_name"
                      data-toggle="popover"
                  ...
                  <div class="font-size-1-1">
                    <span class="mx-2 prapok-wrapper perok-wrapper"
                      ><i class="la la-caret-right"></i></span
                    ><span class="mr-2 prapok-wrapper">মূল-প্রাপক:</span
                    ><span
                      class="prapok-wrapper"
                      data-toggle="popover"
                      data-content="ন্যাশনাল কনসালটেন্ট, ই-সার্ভিস, এসপায়ার টু ইনোভেট (এটু্আই) প্রোগ্রাম"
                      data-original-title=""
                      title=""
                      >এ টি এম আল ফাত্তাহ</span
                    >
                  </div>
                </div>
                <div
                  class="subject-wrapper font-weight-normal font-weight-normal"
                >
                ...
                <div class="font-weight-normal siddhanto-wrapper">
                  ...
                  <span class="text-info font-size-14"
                    >সদয় সিদ্ধান্তের জন্যে প্রেরণ করা হলো</span
                  >
                </div>
                ...
                <div class="d-block">
                  ...
                  >
                    <div class="ml-3 d-flex align-items-center text-primary">
                      <i class="flaticon2-copy mr-2 text-primary"></i>অনুলিপি
                    </div>
                  </div>
                    ...
                    <div class="btn-group folder-wrapper mb-2 mt-3 mr-3">
                      ...
                      <div class="dropdown dropdown-inline">
                        <button
                          type="button"
                          class="
                            btn btn-light-warning btn-icon btn-sm
                            rounded-0
                            alert-warning
                          "
                          data-toggle="dropdown"
                        ...
                        <div
                          class="dropdown-menu dropdown-menu-sm folder_click"
                    ...
                    <div class="mb-2 mt-3 soongukto-wrapper">
                      ...
                      >
                        <button
                          ...
                          class="btn-attachment btn btn-outline-warning btn-sm"
                          type="button"
                        >
                  ...
                  >
                    <a
                      ...
                      data-title="আপনি কি ডাকটি আর্কাইভ করতে চান ?"
                      href="javascript:;"
                      class="
                        mr-1
                        btn
                    ...
                    <button
                      data-info='{"id":54,"origin_office_id":65,"dak_priority":"0","dak_security":"0","dak_type":"Daptorik","is_copied_dak":1,"dak_subject":"sdd","sender":"","attachment_count":1,"sending_date":""}'
                      class="
                        panel_single_daak_forward_dropdown
                        mr-1
                        btn
                        btn-icon
                        btn-square
                    ...
                    >
                      <i
                        data-toggle="popover"
                        data-content="ডাক গতিবিধি"
                        class="fas fa-repeat-alt"
                        data-original-title=""
                        title=""
                      ></i>
                    </button>
  ...
  <br />
  <h2 class="mt-3 text-danger ml-3">লিস্ট স্টাইল ২</h2>
  <div
    class="
      row
      d-md-flex
      ...
      <div class="d-flex align-items-top justify-content-md-between w-100">
          ...
          >
            ...
            >
              <div class="d-flex align-items-center flex-wrap mb-1">
                ...
                <span class="text-dark text-hover-primary mr-2"
                  ><span>অনুচ্ছেদ</span></span
                >
              </div>
            </div>
          </div>
        ...
        <div class="d-block flex-wrap align-self-center">
          <div class="mb-1 d-flex align-items-md-center justify-content-md-end">
            <span class="badge alert-light border p-1 m-1"
              ><i class="fas fa-user-edit"></i
            ></span>
            <span class="badge alert-light border text-purple">---</span>
            <span class="badge alert-light border text-purple"
              >২০/৫/২১ ১০:৪৩ PM</span
            >
          </div>
          <div
            class="
          ...
          <div class="d-md-flex justify-content-end">
            <div class="dropdown">
              ...
              <div
                class="dropdown-menu share-user-list"
  ...
  <br />
  <h2 class="mt-3 text-warning ml-3">লিস্ট স্টাইল ৩</h2>
        ...
        <div class="View nothi-list-item w-100">
          <div class="d-md-flex align-items-start">
            <div class="details-control cursor-pointer align-middle">
              <div
                ...
                "
              >
                <div class="" style="padding: 0px"></div>
                <a
                  class="
                    btn btn-lg btn-icon btn-success btn-square
                    potrojari_all
                  "
                  data-value=""
                  data-toggle="collapse"
                  href="#collapseExample_0"
                  data-target="#collapseExample_0"
                  aria-expanded="false"
                  ><i
                    data-toggle="popover"
                    data-content="সদস্য তালিকা"
                    class="fas fa-users"
                    data-original-title=""
                    title=""
                  ></i
            ...
            <div class="p-3 d-md-flex flex-fill">
              ...
              >
                ...
                <div>
                  <span class="badge alert-primary rounded-0"
                    >মোট সদস্য: ৮
                  </span>
                </div>
              </div>
              <div class="ml-3 mr-2 d-flex align-items-start">
                <span class="mr-2 badge alert-warning rounded-0"> পাবলিক </span>
              </div>
            </div>
          </div>
          <div class="d-flex flex-wrap align-items-start w-100">
            ...
            <div class="card rounded-0 border-0 w-100">
              <div
                class="collapse potrojari_all_exapnded_view"
                id="collapseExample_0"
              ...
              >
                        ...
                        <div id="only_potrojari_user_list_view_toolbar">
                          ...
                          >
                            <div class="btn-group align-items-center pl-3">
                              <span class="mr-2"
                                ><span id="item_length_start"></span> -
                                <span id="item_length_end" class="mr-2"></span
                                >সর্বমোট: <span id="item_total_record"></span
                              ></span>
                              <button
                                id="btn-list-prev"
                ...
                <div class="card card-body user_list_all p-3 rounded-0"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="card card-custom">
      ...
      <div class="card-title">
        <h3 class="card-label">
          ...
          <span class="d-block text-muted pt-2 font-size-sm"
            >Datatable initialized from HTML table</span
          >
        </h3>
      </div>
    ...
    <div class="card-body">
      ...
      <!--begin: Datatable-->
      <div
        class="datatable datatable-default datatable-bordered datatable-loaded"
      >
        <table
          class="datatable-bordered datatable-head-custom datatable-table"
          id="kt_datatable"
          style="display: block"
        >
          <thead class="datatable-head">
            <tr class="datatable-row" style="left: 0px">
              ...
              >
                <span style="width: 108px">Order ID</span>
              </th>
              <th
                data-field="Car Make"
                class="datatable-cell datatable-cell-sort"
              >
                <span style="width: 108px">Car Make</span>
              </th>
              <th
                data-field="Car Model"
                class="datatable-cell datatable-cell-sort"
              >
                <span style="width: 108px">Car Model</span>
              </th>
              <th data-field="Color" class="datatable-cell datatable-cell-sort">
                <span style="width: 108px">Color</span>
              </th>
              <th
                data-field="Deposit Paid"
                class="datatable-cell datatable-cell-sort"
              >
                <span style="width: 108px">Deposit Paid</span>
              </th>
              <th
                data-field="Order Date"
                class="datatable-cell datatable-cell-sort"
              >
                <span style="width: 108px">Order Date</span>
              </th>
              <th
                data-field="Status"
          ...
          <tbody style="" class="datatable-body">
            <tr data-row="0" class="datatable-row" style="left: 0px">
              <td
                data-field="Order ID"
                aria-label="0006-3629"
                class="datatable-cell"
              >
                <span style="width: 108px">0006-3629</span>
              </td>
              <td
                data-field="Car Make"
                ...
                class="datatable-cell"
              >
                <span style="width: 108px">Land Rover</span>
              </td>
              <td
                data-field="Car Model"
                ...
                class="datatable-cell"
              >
                <span style="width: 108px">Range Rover</span>
              </td>
              <td data-field="Color" aria-label="Orange" class="datatable-cell">
                <span style="width: 108px">Orange</span>
              </td>
              <td
                data-field="Deposit Paid"
                aria-label="$22672.60"
                class="datatable-cell"
              >
                <span style="width: 108px">$22672.60</span>
              </td>
              <td
                data-field="Order Date"
                aria-label="2016-11-28"
                class="datatable-cell"
              >
                <span style="width: 108px">2016-11-28</span>
              </td>
              <td
                data-field="Status"
                data-autohide-disabled="false"
                ...
                <span style="width: 108px"
                  ><span
                    class="
                      label
                      font-weight-bold
                      label-lg label-light-primary label-inline
                    "
                    >Canceled</span
                  ></span
                >
            ...
            >
              <td
                data-field="Order ID"
                aria-label="66403-315"
                class="datatable-cell"
              >
                <span style="width: 108px">66403-315</span>
              </td>
              <td data-field="Car Make" aria-label="GMC" class="datatable-cell">
                <span style="width: 108px">GMC</span>
              </td>
              <td
                data-field="Car Model"
                aria-label="Jimmy"
                class="datatable-cell"
              >
                <span style="width: 108px">Jimmy</span>
              </td>
              <td
                data-field="Color"
                ...
                class="datatable-cell"
              >
                <span style="width: 108px">Goldenrod</span>
              </td>
              <td
                data-field="Deposit Paid"
                aria-label="$55141.29"
                class="datatable-cell"
              >
                <span style="width: 108px">$55141.29</span>
              </td>
              <td
                data-field="Order Date"
                aria-label="2017-04-29"
                class="datatable-cell"
              >
                <span style="width: 108px">2017-04-29</span>
              </td>
              <td
                data-field="Status"
                data-autohide-disabled="false"
        ...
        <div class="datatable-pager datatable-paging-loaded">
          ...
          <div class="datatable-pager-info my-2 mb-sm-0">
            <div
              class="dropdown bootstrap-select datatable-pager-size"
              style="width: 60px"
            >
              <select
                class="selectpicker datatable-pager-size"
            ...
            <span class="datatable-pager-detail">Showing 1 - 10 of 143</span>
          </div>
        </div>
      </div>
      <!--end: Datatable-->
