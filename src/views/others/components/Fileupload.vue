<template>
    ...
    <div class="col-md-6">
      <div class="title py-2">
        <h4 class="mb-0 font-weight-bold">
          <i class="fas fa-list mr-3"></i>ফাইল আপলোড
        </h4>
      </div>
    </div>
  </div>
  <div class="px-3 pt-3">
    <div class="card rounded-0 mt-5">
      <h5 class="rounded-0 card-header bg-light py-3 px-5">সংযুক্তিসমূহ</h5>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="fileupload-buttonbar">
                  ...
                  <div
                    class="custom-file fileinput-button input-square"
                    data-toggle="popover"
                    data-content="সর্বোচ্চ ফাইল সাইজ ২৫ মেগাবাইট"
                    data-original-title=""
                    title=""
                  >
                    <input
                      ...
                      id="customFile"
                    />
                    <label class="custom-file-label rounded-0" for="customFile"
                      >ফাইল নির্বাচন</label
                    >
                  </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-sm custom-table">
                <thead class="thead-light">
                  <tr>
                    <th class="py-1" style="text-align: center; width: 100px">
                      মূলপত্র
                    </th>
                  ...
                  <tr class="template-download">
                    <td class="align-middle text-center">
                      <input
                        ...
                        name=""
                        class="dak_form_mulpotro attachment-mulpotro"
                      />
                    </td>
                    ...
                    <td class="align-middle text-center">
                      <span class="preview">
                        <a
                          ...
                          target="_blank"
                          href="#"
                          title="meraj_hossain_CV.pdf"
                          download="meraj_hossain_CV.pdf"
                          data-gallery=""
                    ...
                    <td>
                      <div class="font-13 pl-2 kt-label-font-color-3 name">
                        ...
                        <input
                          style="width: 100%"
                          type="text"
                          value="meraj_hossain_CV.pdf"
                          class="attachment-user-file-name"
                        />
                    ...
                    <td class="align-middle text-center">
                      <button
                        ...
                        data-title="আপনি কি নিশ্চিতভাবে সংযুক্তি টি মুছে ফেলতে চান?"
                        type="button"
                        class="btn btn-danger remove-attachment btn-square"
                        data-url="/nothi-next/daak/attachment/remove"
                        data-name="Dak_2021_65_05_2116215346351619686159.pdf"
                      ...
                      <button
                        type="button"
                        data-type="file.attachment_type"
                        data-base64=""
                        class="
                          d-none
                          btn btn-primary
                          mullpotro-ocr mullpotro-ocr-btn
                          btn-square
                        "
                      >
